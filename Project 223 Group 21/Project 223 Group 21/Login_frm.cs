...
namespace Project_223_Group_21
{
    ...
    {
        public bool BRemeberUser = false;//ND
        public string sRememberUser = "";
        public string sRememberPassword = "";
        public static int fLevel = 0;
        ...
        private void btn_login_Click(object sender, EventArgs e)
        {
            ...
            iLengthName = sUsername.Length;
            iDiffLength = 20 - iLengthName;
            ...
            else
            {
                ...
                //MessageBox.Show(Arrusers[icountindex] + " " + Arrpassword[icountindex]);
                fLevel = int.Parse(Arrlevel[icountindex]);
                MessageBox.Show(fLevel.ToString());
                if (Arrpassword[icountindex] == sPassword && Arrusers[icountindex] == sUsername)
                {
                    MessageBox.Show("Username : " + sUsername + "Password : " + sPassword + "Confirmed");
                    Selection_frm f2 = new Selection_frm();
                    f2.ShowDialog();
                    this.Close();
                }
                else
